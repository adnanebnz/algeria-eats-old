    ...
    <div class="grid sm:px-10 lg:grid-cols-2 lg:px-20 xl:px-32 pb-4 md:pb-10">
        ...
        <div class="mt-10 bg-gray-50 px-4 pt-8 lg:mt-0">
            ...
            <div class="">
                ...
                <label for="billing-address" class="mt-4 mb-2 block text-sm font-medium">Adresse de livraison</label>
                <div class="flex flex-col sm:flex-row">
                    ...
                    <select type="text" name="ville"
                        ...
                        <option value="State">Ville</option>
                        @foreach ($filteredData as $wilayaCode => $wilayaName)
                            <option value="{{ $wilayaCode }}">{{ $wilayaCode }} - {{ $wilayaName }}</option>
                        @endforeach
                    </select>
            ...
            <button
                class="mt-4 mb-8 w-full rounded-md bg-blue-500 hover:bg-blue-600 px-6 py-3 font-medium text-white">Confirmer
                la
                commande</button>
        </div>
    </div>
