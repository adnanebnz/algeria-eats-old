<x-default-layout title='Profile'>
    <div class="px-0 md:px-11">

        <div class="w-full flex flex-col gap-8 justify-center items-center md:pb-16 pb-4">
            <div class="bg-gray-100/40 w-full md:p-4 p-0 mx-auto my-auto rounded-lg shadow-lg">
                    ...
                    <div class="border border-gray-300 rounded-md p-4">
                        ...
                        <div class="mt-4">
                            ...
                            <div class="font-medium text-lg my-2 flex flex-col gap-3 items-center">
                                <p class="font-semibold">Heure d'ouverture : {{ $user->artisan->heure_ouverture }}
                                </p>
                                <p class="font-semibold">Heure de Fermeture : {{ $user->artisan->heure_fermeture }}
                                </p>
                            </div>
                            <div class="mt-4">
        ...
        @if ($user->artisan && $artisanProducts?->count() > 0)
            <div class="self-start bg-gray-100/40 shadow-md w-full px-4 py-6">
                <h1 class="font-black md:text-2xl text-lg">Produits publiés:</h1>
                    ...
                    @foreach ($artisanProducts as $product)
                        <div class="group relative">
                            ...
                            <div class="mt-4 flex flex-col md:flex-row md:justify-between md:items-center">
                                ...
                                <p class="md:text-sm text-xs font-medium text-gray-900">{{ $product->prix }} DZD</p>
                            </div>
                        </div>
                    @endforeach
        ...
        @endif
        @if (auth()->id() === $user->id)
            <h1 class="md:text-3xl text-xl font-black px-4 mb-5 mt-5 self-start">Modifier votre Profile
            </h1>
