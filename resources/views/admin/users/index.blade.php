                                        ...
                                        <tr>
                                            ...
                                            <td
                                                ...
                                                <a href="{{ route('admin.edit', ['user' => $user->id]) }}"
                                                    class="border border-solid border-gray-400  p-1 rounded-md hover:bg-blue-500 hover:text-white">
                                                ...
                                                <form method="POST"
                                                    ...
                                                    @method('DELETE')
                                                    <button type="submit"
                                                        class="border border-solid border-gray-400  p-1 rounded-md hover:bg-red-500 hover:text-white">
                                                        <svg xmlns="http://www.w3.org/2000/svg" fill="none"
                                                            viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor"
                                                            class="w-6 h-6">
                                                            <path stroke-linecap="round" stroke-linejoin="round"
