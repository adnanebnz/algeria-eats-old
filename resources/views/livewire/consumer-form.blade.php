    ...
    <div class="flex flex-col gap-8">
        ...
        <div>
            <button type="submit" wire:loading.attr="disabled" wire:loading.class="cursor-not-allowed bg-orange-400"
                class="flex justify-center w-full rounded-md bg-orange-500 py-2.5 text-md font-semibold leading-6 text-white shadow-sm hover:bg-orange-600 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-orange-500">Créer
                votre compte</button>
