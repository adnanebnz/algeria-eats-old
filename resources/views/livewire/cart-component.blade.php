                            ...
                            @if (Cart::count() > 0)
                                @foreach (Cart::content() as $item)
                                    <div
                                        ...
                                        <div class="p-2 w-12"><img src="{{ $item->model->images[0] }}" alt="image"></div>
                                        <div class="flex-auto text-sm w-32">
                                            <div class="font-bold">{{ $item->model->nom }}</div>
                                            <div class="truncate">{{ $item->model->description }}</div>
