...
Route::put('delivery/{delivery}/accept', [DeliveryManController::class, 'accept'])->name('delivery.accept');
Route::get('delivery/{delivery}/complete', [DeliveryController::class, 'complete'])->name('delivery.complete');
