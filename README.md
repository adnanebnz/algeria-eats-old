...
-   [ ] FILTER BY PRICE IN PRODUCTS
-   [ ] SHOW REVIEWS AND ADD FORM TO CRAETE ONE ON PRODUCTS PAGE AND ARTISANS PAGE
-   [ ] SHOW WISHLISTS FOR USERS
-   [ ] SHOW REVIEWS AND PRODUCTS IN ARTISANS PROFILE
-   [ ] BUILD OTHER PAGES (A propos de nous, terms et conditions, confidentionalité)
-   [ ] BUILD THE SEARCH ENGINE IN INDEX AND PRODUCT PAGE (CREATE A COMPONENT SEARCH ENGINE)
